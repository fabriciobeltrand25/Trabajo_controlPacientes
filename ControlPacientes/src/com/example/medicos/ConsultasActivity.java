		...
		lvConsultas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (consulta.get("estado").equals("Activa")) {
					...
					builder.setPositiveButton("Sí", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							if (dbHelper.finalizarConsulta(idConsulta)) {
								Toast.makeText(ConsultasActivity.this, "✅ Consulta finalizada", Toast.LENGTH_SHORT)
										.show();
								listarConsultas(estadoActual.equals("todas") ? "todas" : estadoActual);
							} else {
								Toast.makeText(ConsultasActivity.this, "❌ Error al finalizar", Toast.LENGTH_SHORT)
										.show();
							}
						}
					});
					...
					Toast.makeText(ConsultasActivity.this, "Esta consulta ya está finalizada", Toast.LENGTH_SHORT)
							.show();
				}
			}
		});
