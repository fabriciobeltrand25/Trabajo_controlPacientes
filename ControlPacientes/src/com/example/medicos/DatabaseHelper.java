...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE_PACIENTES = "CREATE TABLE " + TABLE_PACIENTES + "("
                + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + KEY_IDENTIDAD + " TEXT UNIQUE,"
                + KEY_NOMBRE + " TEXT,"
                + KEY_DIRECCION + " TEXT,"
                + KEY_TELEFONO + " TEXT,"
                + KEY_FECHA_NAC + " TEXT"
        ...
        String CREATE_TABLE_CONSULTAS = "CREATE TABLE " + TABLE_CONSULTAS + "("
                + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + KEY_ID_PACIENTE + " INTEGER,"
                + KEY_ID_MEDICO + " INTEGER,"
                + KEY_FECHA_CONSULTA + " TEXT,"
                + KEY_HORA_CONSULTA + " TEXT,"
                + KEY_VALOR_CONSULTA + " REAL,"
                + KEY_ESTADO + " TEXT,"
                + "FOREIGN KEY(" + KEY_ID_PACIENTE + ") REFERENCES " + TABLE_PACIENTES + "(" + KEY_ID + "),"
                + "FOREIGN KEY(" + KEY_ID_MEDICO + ") REFERENCES " + TABLE_MEDICOS + "(" + KEY_ID + ")"
                + ")";
        db.execSQL(CREATE_TABLE_CONSULTAS);
        
        // Crear tabla Cobros
        String CREATE_TABLE_COBROS = "CREATE TABLE " + TABLE_COBROS + "("
                + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + KEY_ID_CONSULTA + " INTEGER,"
                + KEY_VALOR_BASE + " REAL,"
                + KEY_MORA + " REAL,"
                + KEY_TOTAL_PAGADO + " REAL,"
                + KEY_CAMBIO + " REAL,"
                + KEY_FECHA_PAGO + " TEXT,"
    ...
    private void insertarDatosPrueba(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + TABLE_CONSULTAS + "(" + KEY_ID_PACIENTE + "," + KEY_ID_MEDICO + ","
                ...
                "(1,1,'2026-08-05','09:00:00',500.00,'Activa')," +
                "(2,2,'2026-08-04','10:30:00',500.00,'Finalizada')," +
                "(3,3,'2026-08-04','14:00:00',500.00,'Finalizada')," +
                "(4,4,'2026-08-05','11:00:00',500.00,'Activa')");
        ...
        db.execSQL("INSERT INTO " + TABLE_COBROS + "(" + KEY_ID_CONSULTA + "," + KEY_VALOR_BASE + ","
                ...
                "(2,500.00,20.00,520.00,0.00,'2026-08-05')," +
    ...
    public ArrayList<HashMap<String, String>> buscarMedicos(String busqueda) {
        ArrayList<HashMap<String, String>> lista = new ArrayList<HashMap<String, String>>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(TABLE_MEDICOS, null, 
                KEY_NOMBRE + " LIKE ? OR " + KEY_ESPECIALIDAD + " LIKE ?", 
    ...
    public boolean actualizarMedico(int id, String codigo, String nombre, String especialidad, String telefono, String email) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(KEY_CODIGO, codigo);
        values.put(KEY_NOMBRE, nombre);
    ...
    private boolean tieneConsultasMedico(int idMedico) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(TABLE_CONSULTAS, null, KEY_ID_MEDICO + "=?", 
                new String[]{String.valueOf(idMedico)}, null, null, null);
    ...
    public ArrayList<HashMap<String, String>> buscarPacientes(String busqueda) {
        ...
        Cursor cursor = db.query(TABLE_PACIENTES, null, 
                KEY_IDENTIDAD + " LIKE ? OR " + KEY_NOMBRE + " LIKE ?", 
                new String[]{"%" + busqueda + "%", "%" + busqueda + "%"}, 
                null, null, KEY_NOMBRE);
    ...
    public boolean actualizarPaciente(int id, String identidad, String nombre, String direccion, String telefono, String fechaNac) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(KEY_IDENTIDAD, identidad);
        values.put(KEY_NOMBRE, nombre);
    ...
    public ArrayList<HashMap<String, String>> listarConsultas(String estado) {
        ...
        String query = "SELECT c.*, p." + KEY_NOMBRE + " as paciente, m." + KEY_NOMBRE + " as medico " +
                       "FROM " + TABLE_CONSULTAS + " c " +
                       "JOIN " + TABLE_PACIENTES + " p ON c." + KEY_ID_PACIENTE + "=p." + KEY_ID + " " +
    ...
    public ArrayList<HashMap<String, String>> buscarCobrosPendientes(String identidad) {
        ...
        String query = "SELECT c.*, p." + KEY_NOMBRE + " as paciente, p." + KEY_IDENTIDAD + ", m." + KEY_NOMBRE + " as medico " +
                       "FROM " + TABLE_CONSULTAS + " c " +
                       "JOIN " + TABLE_PACIENTES + " p ON c." + KEY_ID_PACIENTE + "=p." + KEY_ID + " " +
                       "JOIN " + TABLE_MEDICOS + " m ON c." + KEY_ID_MEDICO + "=m." + KEY_ID + " " +
                       "WHERE p." + KEY_IDENTIDAD + "=? AND c." + KEY_ESTADO + "='Finalizada' " +
    ...
    public ArrayList<HashMap<String, String>> reportePacientesMasConsultas() {
        ...
        String query = "SELECT p.*, COUNT(c." + KEY_ID + ") as total_consultas " +
                       "FROM " + TABLE_PACIENTES + " p " +
                       "LEFT JOIN " + TABLE_CONSULTAS + " c ON p." + KEY_ID + "=c." + KEY_ID_PACIENTE + " " +
                       "GROUP BY p." + KEY_ID + " " +
    ...
    public ArrayList<HashMap<String, String>> reporteMedicosMasConsultas() {
        ...
        String query = "SELECT m.*, COUNT(c." + KEY_ID + ") as total_consultas " +
                       "FROM " + TABLE_MEDICOS + " m " +
                       "LEFT JOIN " + TABLE_CONSULTAS + " c ON m." + KEY_ID + "=c." + KEY_ID_MEDICO + " " +
                       "GROUP BY m." + KEY_ID + " " +
                       "HAVING total_consultas > 0 " +
                       "ORDER BY total_consultas DESC";
